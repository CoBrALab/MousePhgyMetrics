...
if [ $_arg_data_type = "respiration" ]; then
   ...
   python3.8 $scriptdir/respiration_functions.py $arg_analysis_type $_arg_input_trace $_arg_tot_length_seconds $_arg_output_path $_arg_output_image_type \
   ...
   echo "Running plethysmography analysis..."
    python3.8 $scriptdir/cardiac_functions.py $arg_analysis_type $_arg_input_trace $_arg_tot_length_seconds $_arg_output_path $_arg_output_image_type \
			$_arg_peak_detection_parameter_csv $_arg_invert_trace_boolean $_arg_window_length $_arg_fmri_censoring_mask_csv $_arg_fmri_tr $_arg_average_metrics_window_length $_arg_average_metrics_window_overlap
